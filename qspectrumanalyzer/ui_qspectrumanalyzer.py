...
class Ui_QSpectrumAnalyzerMainWindow(object):
    def setupUi(self, QSpectrumAnalyzerMainWindow):
        ...
        self.cropSpinBox = QtWidgets.QDoubleSpinBox(self.settingsDockWidgetContents)
        ...
        self.cropSpinBox.setDecimals(1)
        self.cropSpinBox.setMinimum(-1.0)
        self.cropSpinBox.setMaximum(999.0)
        self.cropSpinBox.setSingleStep(1.0)
        self.cropSpinBox.setProperty("value", -1.0)
